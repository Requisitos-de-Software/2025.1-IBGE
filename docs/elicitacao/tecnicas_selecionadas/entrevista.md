...
As entrevistas foram conduzidas de forma remota por meio de videochamada, com consentimento prévio dos participantes. As conversas foram gravadas e transcritas para análise. Utilizamos um roteiro base (que pode ser acessado [aqui](../../assets/documents/EntrevistaIBGE_QuestionárioBase.pdf)), com abertura para adaptações conforme a experiência e perfil de cada entrevistado.
...
Abaixo se encontra um resumo da Entrevista 1, com o funcionário Christiano. As perguntas e respostas na íntegra podem ser visualizadas [aqui](../../assets/documents/Questionário%20IBGE%20-%20Christiano%20(Funcionário1).pdf).
...
Abaixo se encontra um resumo da Entrevista 2, com o funcionário Christiano. As perguntas e respostas na íntegra podem ser visualizadas [aqui](../../assets/documents/Questionário%20IBGE%20-%20Erick%20(Funcionário2).pdf).
...
<!-- - É contra a realização do Censo diretamente pelo cidadão via aplicativo, por acreditar que isso comprometeria a veracidade dos dados.

- Afirma que o papel do agente de pesquisa é essencial para a coleta confiável. -->
...
<font size="3"><p style="text-align: center">Fonte: [João Félix](https://github.com/joaofmoreiraa), [Larysssa Felix](https://github.com/felixlaryssa), [Letícia Monteiro](https://github.com/LeticiaMonteiroo) e [Ludmila Nunes](https://github.com/ludmilaaysha).</p></font>
